...
// out: publicKey, privateKey
void extern rsaKeyGeneration(public_key *publicKey, private_key *privateKey);
void extern rsaKeyGeneration2(public_key* publicKey, private_key* privateKey);
